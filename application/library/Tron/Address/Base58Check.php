...
class Base58Check
{
     ...
     * @return string
     */
    public static function encode( $string,  $prefix = 128,  $compressed = true)
    {
     ...
     * @return bool|string
     */
    public static function decode( $string,  $removeLeadingBytes = 1,  $removeTrailingBytes = 4,  $removeCompression = true)
    {
