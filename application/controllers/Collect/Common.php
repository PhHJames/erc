<?php
//码商的基类控制器
class Collect_CommonController extends Yaf_Controller_Abstract {
    public $userInfo = array();
    public $isLogin = false ;
    public $current_url = '';
	public function init() {
	    $this->showError("温馨提示" , "此系统不支持码商.无需码商 ");
        $this->checkCommon();
        $this->assignVariable();
        $this->initLogin();
	}
    ...
    public function getCookeVal(){
        global $_G;
        $cookie_name ="collect_admin_auth";
    ...
    public function displayTemplate($file = null , $args = array()){
        ...
        $_G['viewObject']->display( "collect/" . $file.".htm");
    }
    //显示错误页面,并且根据时间进行跳转
