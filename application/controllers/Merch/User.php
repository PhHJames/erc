 ...
 */
class Merch_UserController extends Merch_CenterController {
    ...
    public function makeSecretAction(){
    ...
    private function doEditbase(){
        ...
        $c_url = isset($params['c_url'])?trim($params['c_url']):'';
        ...
        /*if( empty($chain_name) ){
            Common::EchoResult(-3 , "请输入收款的链名称");
        }
        if( empty($c_url) ){
            Common::EchoResult(-3 , "请输入收款的币地址");
        }*/
    ...
    private function doEditpasswd(){
        ...
        $Business = Common::ImportBusiness("Merch" , "Merch" );
        try{
